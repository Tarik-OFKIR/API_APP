...
module.exports = {
    up: async(queryInterface, Sequelize) => {
        ...
        await queryInterface.bulkInsert('Users', [...Array(20)].map((user) => ({
        ...
        await queryInterface.bulkInsert('Articles', [...Array(200)].map((Article) => ({
        ...
        await queryInterface.bulkInsert('Tags', [...Array(10)].map((Tag) => ({
        ...
        await queryInterface.bulkInsert('Comments', [...Array(2000)].map((Comment) => ({
